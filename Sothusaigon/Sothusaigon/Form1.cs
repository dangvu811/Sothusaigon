...
namespace Sothusaigon
{
    public partial class Form1 : Form
    {
        ...
        {
            timer1.Enabled = true;
            this.lstThumoi.MouseDown += new MouseEventHandler(
            this.lstThumoi_MouseDown);
        ...
        private void lstThumoi_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (index != -1)
            {
                ...
                //{
                //    lstThumoi.Items.RemoveAt(lstThumoi.IndexFromPoint(e.X, e.Y));
                //}
            }
        }
        ...
        private void lstdanhsach_DragDrop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent(DataFormats.StringFormat))
            {
                ...
                {
                    MessageBox.Show("Con vật này đã có trong danh sách!","Chú ý!",MessageBoxButtons.OK,MessageBoxIcon.Warning);
                }

                //lstdanhsach.Items.Add(str);
